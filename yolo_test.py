...
# === Set input image folder (generic, user-defined) === #
image_folder = input("Enter the path to the image folder: ") #Or input directly here
output_path = "output_images/"  # Folder to save annotated images
...
# === Process each image === #
for idx, image_file in enumerate(image_files[:10]):  # Process first 10 images for now
